...
- [4. Build a simple full-stack web application named ""**Plant Garden Tracker**""](#4-build-a-simple-full-stack-web-application-named-plant-garden-tracker)
---
...
## 4. Build a simple full-stack web application named **Plant Garden Tracker**.
