...
- [4. Build a full-stack web application named ""**Plant Garden Tracker**""](#4-build-a-full-stack-web-application-named-plant-garden-tracker)
---
...
## 4. Build a full-stack web application named **Plant Garden Tracker**.
